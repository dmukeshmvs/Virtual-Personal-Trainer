          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              <label className="block text-xs font-semibold text-[#443049] dark:text-gray-300 mb-1.5">
                <i className="fa-solid fa-magnifying-glass mr-1.5 text-[#775fab]"></i>
                Search Exercises
              </label>
              <div className="relative group">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 transition-colors duration-300 group-focus-within:text-[#775fab]">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2 text-sm bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-600 rounded-lg text-gray-700 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 transition-all duration-300 hover:border-[#775fab]/50 hover:shadow-md focus:outline-none focus:border-[#775fab] focus:shadow-lg focus:shadow-[#775fab]/10"
                />
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          {filteredExercises.length > 0 ? (
              ...
              {totalPages > 1 && (
                <div className="flex justify-center gap-2 mt-12">
                  <button
                    ...
                    disabled={page === 1}
                    className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 dark:text-gray-300 disabled:opacity-50"
                  >
                    Previous
                  </button>
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg ${
                        page === i + 1
                          ...
                          : 'border border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-800 dark:text-gray-300'
                      }`}
                    >
                      {i + 1}
                    </button>
            ...
            <div className="text-center py-12">
              <p className="text-gray-600 dark:text-gray-400 text-lg">No exercises found. Try adjusting your filters.</p>
            </div>
          )}
        </div>
      </div>

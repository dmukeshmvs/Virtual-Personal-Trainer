    ...
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-white dark:from-black dark:to-gray-900 pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-[#32284a] dark:text-white mb-4">Terms of Service</h1>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg dark:shadow-black/20 p-8 md:p-12 space-y-8">
            ...
            {/* Acceptance of Terms */}
            <section>
              <h2 className="text-2xl font-bold text-[#32284a] dark:text-white mb-4">2. Acceptance of Terms</h2>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            {/* User Accounts */}
            <section>
              <h2 className="text-2xl font-bold text-[#32284a] dark:text-white mb-4">3. User Accounts</h2>
            ...
            {/* Use of Services */}
            <section>
              <h2 className="text-2xl font-bold text-[#32284a] dark:text-white mb-4">4. Use of Services</h2>
            ...
            {/* Trainer Services */}
            <section>
              <h2 className="text-2xl font-bold text-[#32284a] dark:text-white mb-4">5. Trainer Services</h2>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#32284a] dark:text-white mb-4">6. Intellectual Property</h2>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#32284a] dark:text-white mb-4">7. Limitation of Liability</h2>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            {/* Termination */}
            <section>
              <h2 className="text-2xl font-bold text-[#32284a] dark:text-white mb-4">8. Termination</h2>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            {/* Changes to Terms */}
            <section>
              <h2 className="text-2xl font-bold text-[#32284a] dark:text-white mb-4">9. Changes to Terms</h2>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            {/* Contact */}
            <section>
              <h2 className="text-2xl font-bold text-[#32284a] dark:text-white mb-4">10. Contact Us</h2>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
